...
this.handleChange = this.handleChange.bind(this);
  ...
  this.removeAuthListener = fire.auth().onAuthStateChanged(user=>{
    ...
    currentProjectRef.on('value', (snapshot) => {
      ...
      const samplesRef = fire.database().ref(`${this.state.currentCompany}/${this.state.currentProject}/Manuals`);
  ...
  removeReport(itemId) {
    this.removeAuthListener = fire.auth().onAuthStateChanged(user=>{
    const sampleRef = fire.database().ref(`${this.state.currentCompany}/${this.state.currentProject}/Manuals/${itemId}`);
    sampleRef.remove();
  });
  }
...
fillStates = (itemId) => {
  ...
  let id = fire.database().ref().child(`${this.state.currentCompany}/${this.state.currentProject}/Manuals/${itemId}`).key;
...
writeData = (e) => {
  ...
  this.removeAuthListener = fire.auth().onAuthStateChanged(user=>{
  const samplesRef = fire.database().ref(`${this.state.currentCompany}/${this.state.currentProject}/Manuals/${this.state.id}`);

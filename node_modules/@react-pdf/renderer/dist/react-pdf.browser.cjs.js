...
var flatten = function flatten(input) {
  ...
  var result = input.reduce(function (acc, style) {
    if (style) {
      ...
      _Object$keys(s).forEach(function (key) {
...
var applyContainObjectFit = function applyContainObjectFit(cw, ch, iw, ih, px, py) {
  ...
  if (cr > ir) {
    ...
    return { width: _width, height: _height, yOffset: _yOffset, xOffset: _xOffset };
  }
};
...
var applyCoverObjectFit = function applyCoverObjectFit(cw, ch, iw, ih, px, py) {
  ...
  if (cr > ir) {
    ...
    var yOffset = isNumeric(py) ? py : (ch - height) * pyv;
    return { width: width, height: height, yOffset: yOffset, xOffset: xOffset };
  } else {
    var _height2 = ch;
    var _width2 = _height2 * ir;
    var _xOffset2 = isNumeric(px) ? px : (cw - _width2) * pxv;
    var _yOffset2 = isNumeric(py) ? py : 0;
    return { width: _width2, height: _height2, xOffset: _xOffset2, yOffset: _yOffset2 };
  }
};
...
var Image$1 = function (_Base) {
  ...
  Image.prototype.renderImage = function renderImage() {
    ...
    var _getComputedStyles = this.getComputedStyles(),
        objectPositionX = _getComputedStyles.objectPositionX,
        objectPositionY = _getComputedStyles.objectPositionY;
    ...
    if (this.image.data) {
      var _resolveObjectFit = resolveObjectFit(this.props.style.objectFit, this.width - padding.left - padding.right, this.height - padding.top - padding.bottom, this.image.width, this.image.height, objectPositionX, objectPositionY),
      ...
      if (width !== 0 && height !== 0) {
        this.root.instance.image(this.image.data, left + padding.left + xOffset, top + padding.top + yOffset, { width: width, height: height });
      } else {
